...
const Frontend = ({ attributes }) => {
  ...
  const { controlPosition, showPrintButton, showMarkerText, showDirectionFromYourLocation, getYourLocation, getLocationControlPosition, showLocationDetailsOnClick } = mapOptions;
  ...
  useEffect(() => {
    ...
    `;
        ...
        getLocationContainer.addEventListener('click', () => {
          ...
          const marker = L.marker([currentLocation.lat, currentLocation.lon], { icon: getMarkerIcon(iconContent, iconColor) }).addTo(map);
